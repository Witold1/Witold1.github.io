...
function filterSelection(c) {
  var x, i;
  x = document.getElementsByClassName("gallery-filter-content");
  if (c == "all") c = "";
...
var ContentControlButtons = ContentControlButtonContainer.getElementsByClassName("content-control-button");
